...
const AdInvoiceModal = ({ open, onClose, ad }) => {
    ...
    const handlePrint = () => {
        ...
        windowPrint.document.write(`
            <html>
                <head>
                    <title>فاتورة إعلان - ${ad.title}</title>
                    <style>
                ...
                <body>
                    <div class="header">
                        <div>
                            ...
                            <p style="margin: 5px 0 0 0; color: #6b7280; font-size: 14px;">نظام إدارة الشاشات الإعلانية الذكية</p>
                        </div>
                        <div style="text-align: left;">
                            <h1 class="invoice-title">فاتورة إعلانية</h1>
                    ...
                    <div class="meta-info">
                        <div class="meta-box">
                            ...
                            <p>${ad.advertiser?.name || 'غير متوفر'}</p>
                        ...
                        <div class="meta-box">
                            ...
                            <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                <span style="color: #6b7280; font-weight: normal;">تاريخ الإصدار:</span>
                                <span>${new Date(ad.created_at || ad.uploaded_at).toLocaleDateString('ar-SA')}</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                <span style="color: #6b7280; font-weight: normal;">حالة الدفع:</span>
                                <span style="color: #059669;">مدفوعة (مكتمل)</span>
                            </div>
                            <div style="display: flex; justify-content: space-between;">
                                <span style="color: #6b7280; font-weight: normal;">باقة التكرار:</span>
                                <span>${ad.package_name || 'تخصيص حر'}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <span style="color: #6b7280; font-size: 12px;">تصنيف: ${ad.category?.category_name || 'عام'}</span>
                                </td>
                                <td><span dir="ltr">${ad.start_date || '—'}</span></td>
                                <td><span dir="ltr">${ad.end_date || '—'}</span></td>
                                <td>${ad.screens?.length || 0} شاشة</td>
                    ...
                    <div class="total-section">
                        <div class="total-box">
                            <div class="total-row">
                                <span style="color: #4b5563;">المجموع الفرعي</span>
                                <span>$${ad.total_cost || '0.00'}</span>
                            </div>
                            <div class="total-row">
                                <span style="color: #4b5563;">الضرائب (0%)</span>
                                <span>$0.00</span>
                            </div>
                    ...
                    <div class="footer">
                        <p>شكراً لثقتكم بخدمات SabaControl الإعلانية.</p>
                        <p>هذه الفاتورة إلكترونية وصادرة من النظام الآلي، ولا تحتاج لتوقيع.</p>
                    </div>
                </body>
            </html>
        `);
    ...
    return (
        <AnimatePresence>
            {open && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" dir="rtl" style={{ fontFamily: "'IBM Plex Sans Arabic', sans-serif" }}>
                    <motion.div
                    ...
                    >
                        ...
                        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-gray-900">فاتورة إعلانية</h2>
                            ...
                            <div className="bg-white p-10 rounded-xl shadow-sm border border-gray-200 mx-auto max-w-2xl relative" ref={printRef}>
                                ...
                                <div className="flex justify-between items-start border-b-2 border-gray-100 pb-6 mb-8">
                                    <div>
                                        ...
                                        <p className="text-gray-500 text-sm mt-1">نظام إدارة الشاشات الإعلانية الذكية</p>
                                    </div>
                                    <div className="text-left">
                                        <h2 className="text-2xl font-bold text-gray-800">فاتورة رقمية</h2>
                                ...
                                <div className="grid grid-cols-2 gap-8 mb-8">
                                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">معلومات المعلن</h3>
                                        <p className="text-base font-bold text-gray-900">{ad.advertiser?.name || 'غير متوفر'}</p>
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                        ...
                                        <div className="space-y-2 text-sm">
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-semibold text-gray-900">{new Date(ad.created_at || ad.uploaded_at).toLocaleDateString('ar-SA')}</span>
                                            </div>
                                            <div className="flex justify-between">
                                            ...
                                            <div className="flex justify-between">
                                                <span className="text-gray-500">باقة البث:</span>
                                                <span className="font-semibold text-gray-900">{ad.package_name || 'تخصيص حر'}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Items Table */}
                                <div className="mb-8">
                                    <h3 className="text-lg font-bold text-gray-900 mb-4">تفاصيل الحملة الإعلانية</h3>
                                    <div className="border border-gray-200 rounded-xl overflow-hidden">
                                        <table className="w-full text-sm text-right">
                                            <thead className="bg-gray-50 border-b border-gray-200 text-gray-600">
                                                <tr>
                                                    <th className="px-4 py-3 font-semibold">الوصف</th>
                                                    <th className="px-4 py-3 font-semibold text-center">التاريخ</th>
                                                    <th className="px-4 py-3 font-semibold text-center">الشاشات</th>
                                                    <th className="px-4 py-3 font-semibold text-center">المدة</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-gray-100">
                                                <tr className="bg-white">
                                                    <td className="px-4 py-4">
                                                        ...
                                                        <div className="text-gray-500 text-xs mt-1">تصنيف: {ad.category?.category_name || 'عام'}</div>
                                                    </td>
                                ...
                                <div className="text-center pt-8 border-t border-gray-100 text-gray-400 text-xs">
                                    <p className="mb-1">شكراً لثقتكم بخدمات SabaControl الإعلانية.</p>
                                    <p>هذه الفاتورة إلكترونية وصادرة من النظام الآلي، ولا تحتاج لتوقيع أو ختم.</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
