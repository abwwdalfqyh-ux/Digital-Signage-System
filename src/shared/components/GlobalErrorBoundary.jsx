            ...
            return (
                <div className="min-h-screen bg-[#0a0a0c] flex items-center justify-center p-4">
                    <div className="bg-[#121215]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-10 max-w-md text-center">
                        ...
                        <h2 className="text-2xl font-black text-white mb-3">{t('common.unexpected_error')}</h2>
                        <p className="text-gray-500 text-sm mb-8">{t('common.error_apology')}</p>
                        <button
...
const GlobalErrorBoundary = (props) => {
    ...
    return <GlobalErrorBoundaryInner t={t} {...props} />;
};
